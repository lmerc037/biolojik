...
class Contact extends Component {
                    ...
                    <div className="col-md-4 col-sm-12">
                      <div className="contact_pg_address">
                        ...
                        <div className="single_con_add">
                          ...
                          <p>
                            <span>123 Rue Inconnue, Gatineau, QC, J8P-2H3</span>
                          </p>
                        </div>
                        <div className="single_con_add">
                          <a href="#/">
  ...
  handleChangeEmail(e) {
    ...
    else if (EmailReg.test(e.target.value)) this.setState({ email_err: "(-_-)Il faut un courriel valide pour vous joindre" });
    else
      this.setState({
        email_err: 'Ça semble correct',
      });
  }
  ...
  handleSubmit1() {
    ...
    if (
      ...
      this.setState({
        return_msg: "Commencer par remplir tous les champs ",
        flag: true,
      });
    } else {
      this.setState({ return_msg: "L'email à été envoyer avec Succès.", flag: true });
    }
  }
}
