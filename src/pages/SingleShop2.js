...
class SingleShop2 extends Component {
  render() {
    return (
      <Fragment>
        <MetaTags>
                  ...
                  <div className="col-md-6 col-sm-12">
                    <div className="allproduct-info">
                      <div className="tittle_product">
                        <Link to="single-shop">Panier 3</Link>
                      </div>
                      ...
                      <div className="p-content">
                        ...
                        Le panier 3* contient ne variété de  legumes de saison incluant: Radis, Lettu, Choux, Bettraves.
                      ...
                      <div className="allchoices">
                        <div className="choice-icon">
                          <ul>
                            <li>
                              <Link
                                to={process.env.PUBLIC_URL + "/reservation2"}
